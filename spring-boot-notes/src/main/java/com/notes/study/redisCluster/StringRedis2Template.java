 ...
 * @author Costin Leau
 */
public class StringRedis2Template extends RedisTemplate<String, String> {

	/**
	 * Constructs a new <code>StringRedis2Template</code> instance. {@link #setConnectionFactory(RedisConnectionFactory)}
	 * and {@link #afterPropertiesSet()} still need to be called.
	 */
	public StringRedis2Template() {
	...
	/**
	 * Constructs a new <code>StringRedis2Template</code> instance ready to be used.
	 * 
	 * @param connectionFactory connection factory for creating new connections
	 */
	public StringRedis2Template(RedisConnectionFactory connectionFactory) {
		this();
